...
class ComputeOpticalFlow(AC_FUN):
    def __init__(self):
        pass
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "tips": ("STRING",{"multiline":False,"default":"计算机视觉图像"}),
            },
        }
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "image": ("IMAGE",),
                "flow": ("OPTICAL_FLOW",),
                "tips": ("STRING",{"multiline":False,"default":"应用视觉图像"}),
            },
        }
...
class VisualizeOpticalFlow(AC_FUN):
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "image": ("IMAGE",),
                "flow": ("OPTICAL_FLOW",),
                "tips": ("STRING",{"multiline":False,"default":"视觉图像选项"}),
            },
        }
    ...
    def visualize_flow(self, image, flow,tips=None):
